import GothamNarrowBlack from './fonts/GothamNarrowBlack.ttf'
import { createTheme } from '@mui/material/styles'
import { createBreakpoints } from '@mui/system'

const appName = process.env.REACT_APP_STORENAME || 'visiondirect'
...
export const themeProps = {
  ...
  typography: {
    ...
    h1: {
      fontFamily: '"Gotham Narrow Black", "Arial", sans-serif',
    ...
    MuiCssBaseline: {
      styleOverrides: `
        @font-face {
          ...
          font-display: swap;
          font-weight: 450;
          src: local('Gotham Narrow Black'), local('GothamNarrowBlack'), url(${GothamNarrowBlack}) format('truetype');
        }
      `,
    },
    // DO NOT PUT ANY COMPONENT STYLE OVERIDES HERE, USE THE COMPONENT OVERRIDES INSTEAD
  },
}
